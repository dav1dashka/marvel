 ...
 */            function f(a, b) {
    ...
    (() => {
        ...
        const AppHeader = () => react.createElement("header", {
            className: "app__header"
        }, react.createElement("h1", {
            className: "app__title"
        }, react.createElement("a", {
            href: "#"
        }, react.createElement("span", null, "Marvel"), " information portal")), react.createElement("nav", {
            className: "app__menu"
        }, react.createElement("ul", null, react.createElement("li", null, react.createElement("a", {
            href: "#"
        }, "Characters")), "/", react.createElement("li", null, react.createElement("a", {
            href: "#"
        }, "Comics")))));
        const appHeader_AppHeader = AppHeader;
        ...
        class MarvelService {
            ...
            _apiKey="apikey=40f9e59fb276bb8c51cd468d5f0bfbd7";
            _beseOffset=210;
            getResourses=async url => {
                let result = await fetch(url);
                if (!result.ok) throw new Error(`Could not fetch this ${url}, status ${result.status}`);
                return await result.json();
            };
            getAllCharacters=async (offset = this._beseOffset) => {
                const result = await this.getResourses(`${this._apiBase}characters?limit=9&offset=${offset}&${this._apiKey}`);
                return result.data.results.map(this._transformCharacter);
            };
            getOneCharacter=async id => {
                const result = await this.getResourses(`${this._apiBase}characters/${id}?&${this._apiKey}`);
                if (await result.data.results[0].description.length == 0) result.data.results[0].description = "There is no description";
                if (await result.data.results[0].description.length > 100) result.data.results[0].description = result.data.results[0].description.slice(0, 100) + "...";
            ...
            render() {
                console.log(this.marvelServise.getOneCharacter());
            }
        }
        const MarvelServices = MarvelService;
        const mjolnir = __webpack_require__.p + "61f31e1809f12183a524e2d89f56f05f.png";
        const ErrorMessage = () => react.createElement("div", {
            className: "errorMessage"
        }, "Problem has occurred");
        const errorMessage_ErrorMessage = ErrorMessage;
        class RandomChar extends react.Component {
            ...
            marvelServise=new MarvelServices;
            ...
            updateChar=() => {
                ...
                const id = Math.floor(Math.random() * (1011400 - 1011e3) + 1011e3);
                this.marvelServise.getOneCharacter(id).then(this.onCharacterLoaded).catch(this.onError);
            };
            onError=() => {
                this.setState({
                    loading: false,
            ...
            render() {
                ...
                const errorMessage = error ? react.createElement(errorMessage_ErrorMessage, null) : null;
                const spinner = loading ? react.createElement(spinner_Spinner, null) : null;
                const content = !(loading || error) ? react.createElement(RenderView, {
                    character
                }) : null;
                return react.createElement("div", {
                    className: "randomchar"
                }, errorMessage, spinner, content, react.createElement("div", {
                    className: "randomchar__static"
                }, react.createElement("p", {
                    className: "randomchar__title"
                }, "Random character for today!", react.createElement("br", null), "Do you want to get to know him better?"), react.createElement("p", {
                    className: "randomchar__title"
                }, "Or choose another one"), react.createElement("button", {
                    className: "button button__main"
                }, react.createElement("div", {
                    onClick: this.updateChar,
                    className: "inner"
                }, "try it")), react.createElement("img", {
                    src: mjolnir,
                    alt: "mjolnir",
        ...
        const RenderView = ({character}) => {
            const {name, description, thumbnail, homepage, wiki} = character;
            const tumbnailObjFit = thumbnail === "http://i.annihil.us/u/prod/marvel/i/mg/b/40/image_not_available.jpg" ? "contain" : "cover";
            return react.createElement("div", {
                className: "randomchar__block"
            }, react.createElement("img", {
                src: thumbnail,
                style: {
                    objectFit: tumbnailObjFit
                },
                ...
                className: "inner"
            }, "homepage")), react.createElement("a", {
                href: wiki,
        ...
        const randomChar_RandomChar = RandomChar;
        ...
        class CharList extends react.Component {
            ...
            renderItems(arr) {
                const items = arr.map((item => {
                    ...
                    if (item.thumbnail === "http://i.annihil.us/u/prod/marvel/i/mg/b/40/image_not_available.jpg") imgStyle = {
                        objectFit: "unset"
                    };
        ...
        CharList.propTypes = {
            onCharSelected: prop_types_default().func
        };
        const charList_CharList = CharList;
        const Skeleton = () => react.createElement(react.Fragment, null, react.createElement("p", {
            className: "char__select"
        }, "Please select a character to see information"), react.createElement("div", {
            className: "skeleton"
        }, react.createElement("div", {
            ...
            className: "pulse skeleton__mini"
        })), react.createElement("div", {
            className: "pulse skeleton__block"
        }), react.createElement("div", {
            className: "pulse skeleton__block"
        }), react.createElement("div", {
            className: "pulse skeleton__block"
        ...
        class CharInfo extends react.Component {
            ...
            updateChar=() => {
                ...
                if (!charId) return;
                this.onCharacterLoading();
                this.marvelServise.getOneCharacter(charId).then(this.onCharacterLoaded).catch(this.onError);
            };
            onCharacterLoaded=character => {
                this.setState({
                    character,
            ...
            render() {
                const {character, loading, error} = this.state;
                const skeleton = character || loading || error ? null : react.createElement(skeleton_Skeleton, null);
                const errorMessage = error ? react.createElement(errorMessage_ErrorMessage, null) : null;
                const spinner = loading ? react.createElement(spinner_Spinner, null) : null;
                const content = !(loading || error || !character) ? react.createElement(CharInfo_RenderView, {
                    character
                }) : null;
                return react.createElement("div", {
        ...
        const CharInfo_RenderView = ({character}) => {
            const {name, description, thumbnail, homepage, wiki, comics} = character;
            const tumbnailObjFit = thumbnail === "http://i.annihil.us/u/prod/marvel/i/mg/b/40/image_not_available.jpg" ? "contain" : "cover";
            let mapComicses = comics.map(((item, i) => react.createElement("li", {
                key: i,
                className: "char__comics-item"
            }, item.name)));
            if (mapComicses.length >= 10) mapComicses = mapComicses.slice(0, 10);
            const noContent = "There is no comics where this character could be.";
            const content = mapComicses.length == 0 ? noContent : mapComicses;
            return react.createElement(react.Fragment, null, react.createElement("div", {
                ...
                className: "inner"
            }, "Wiki"))))), react.createElement("div", {
                className: "char__descr"
            }, description), react.createElement("div", {
                className: "char__comics"
            }, "Comics:"), react.createElement("ul", {
                className: "char__comics-list"
            }, content));
        };
        CharInfo.propTypes = {
            charId: prop_types_default().number
        };
        const charInfo_CharInfo = CharInfo;
        class ErrorBoundary extends react.Component {
            ...
            render() {
                if (this.state.hasError) return react.createElement("p", null, "BAD BDA BAD");
        ...
        class App extends react.Component {
            ...
            render() {
                return react.createElement("div", {
                    className: "app"
                }, react.createElement(appHeader_AppHeader, null), react.createElement("main", null, react.createElement(randomChar_RandomChar, null), react.createElement("div", {
                    className: "char__content"
                }, react.createElement(charList_CharList, {
                    onCharSelected: this.onCharSelected
                }), react.createElement(errorBoundary_ErrorBoundary, null, " ", react.createElement(charInfo_CharInfo, {
        ...
        client.createRoot(root).render(react.createElement(app_App, null));
        function isWebp() {
